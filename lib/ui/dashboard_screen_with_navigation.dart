...
class DashboardScreenWithNavigation extends StatefulWidget {
  static const String id = "DashboardScreen";
  final StatefulNavigationShell navigationShell;

  const DashboardScreenWithNavigation({Key? key,required this.navigationShell})
      : super(key: key ?? const ValueKey('DashboardScreenWithNavigation') );

  @override
  State<StatefulWidget> createState() => DashboardScreenWithNavigationState();
}

class DashboardScreenWithNavigationState extends State<DashboardScreenWithNavigation> {
  String? gLat;
  String? gLong;
